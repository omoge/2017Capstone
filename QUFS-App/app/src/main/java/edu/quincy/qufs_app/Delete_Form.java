...
public class Delete_Form extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(inflater.inflate(R.layout.activity_delete__form, null))

                // Add action buttons
                .setPositiveButton("DELETE", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int id) {
                        deleteStudentListener.onDeleteButtonClick(Delete_Form.this);
                    }
                })
                .setNegativeButton("CANCEL", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Delete_Form.this.getDialog().cancel();
                    }
                });
